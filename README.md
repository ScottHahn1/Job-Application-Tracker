...
The goal of this project was to build a production-ready CRUD application with JWT authentication, protected routes, persistent login, nd a modern frontend using React, TypeScript, and Tailwind CSS.
...
- **Dashboard Statistics**: Provides an overview of job search progress by displaying total applications and the percentage distribution across each application status.
